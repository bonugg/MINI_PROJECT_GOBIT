package com.gobit.minipj_gobit.noticeDept.file;
...
public class FileUtil {
     ...
     */
    public List<nBoardFile> uploadFiles(final List<MultipartFile> multipartFiles) {
        List<nBoardFile> files = new ArrayList<>();
     ...
     */
    public nBoardFile uploadFile(final MultipartFile multipartFile) {
    ...
    public Resource readFileAsResource(final nBoardFile file) {
